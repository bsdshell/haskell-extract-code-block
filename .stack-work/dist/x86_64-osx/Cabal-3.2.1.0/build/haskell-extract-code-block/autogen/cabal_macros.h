...
/* package haskell-extract-code-block-0.1.0.0 */
#ifndef VERSION_haskell_extract_code_block
#define VERSION_haskell_extract_code_block "0.1.0.0"
#endif /* VERSION_haskell_extract_code_block */
#ifndef MIN_VERSION_haskell_extract_code_block
#define MIN_VERSION_haskell_extract_code_block(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskell_extract_code_block */
...
#define CURRENT_COMPONENT_ID "haskell-extract-code-block-0.1.0.0-8LAKjMXWlCHEJZnwanvuE3-haskell-extract-code-block"
