...
# stack build haskell-extract-code-block 
# stack exec haskell-extract-code-block 
...
if [[ "$#" -eq 1 ]];then
    ...
    stack build haskell-extract-code-block && stack exec haskell-extract-code-block 
fi
